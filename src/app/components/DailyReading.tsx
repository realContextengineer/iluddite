    ...
    <div className="max-w-xl mx-auto space-y-4">
      ...
      <AnimateIn delay={0}>
        <div className="rounded-2xl p-8 bg-gradient-to-br from-[#D4793A]/10 to-[#D4793A]/5 dark:from-[#E07A3A]/10 dark:to-[#E07A3A]/5 border border-[#D4793A]/20 dark:border-[#E07A3A]/20 transition-colors duration-500">
          <div className="text-center space-y-3">
            ...
            {reading.holidayNote && (
              <p className="text-[13px] text-[#D4793A] dark:text-[#E07A3A] leading-relaxed max-w-md mx-auto">
                {reading.holidayNote}
              </p>
            )}
          </div>
        ...
        <div className="bg-white dark:bg-[#1A1A1A] rounded-2xl p-8 shadow-sm border border-[#E8E4DD]/60 dark:border-[#2A2A2A] transition-colors duration-500">
          <div className="flex items-center gap-2.5 mb-5">
            <div className="w-7 h-7 rounded-full bg-[#D4793A]/10 dark:bg-[#E07A3A]/10 flex items-center justify-center">
              <BookOpen className="w-3.5 h-3.5 text-[#D4793A] dark:text-[#E07A3A]" />
            </div>
      ...
      <AnimateIn delay={0}>
        <div className="bg-white dark:bg-[#1A1A1A] rounded-2xl p-7 shadow-sm border border-[#E8E4DD]/60 dark:border-[#2A2A2A] transition-colors duration-500">
          <div className="flex items-center gap-2.5 mb-4">
            <div className="w-7 h-7 rounded-full bg-[#D4793A]/10 dark:bg-[#E07A3A]/10 flex items-center justify-center">
              <Quote className="w-3.5 h-3.5 text-[#D4793A] dark:text-[#E07A3A]" />
            </div>
            <h2 className="text-[10px] text-[#999] dark:text-[#555] uppercase tracking-[0.15em] font-semibold font-mono">
              Random Quote
            </h2>
          ...
          <div className="space-y-2">
            <p className="text-[16px] sm:text-[17px] text-[#1A1A1A] dark:text-[#E8E4DD] leading-[1.7]">
              "{reading.quote}"
            </p>
